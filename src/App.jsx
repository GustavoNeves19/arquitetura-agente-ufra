...
import { generateAgentWithLLM, hasApiKey } from './lib/apiGenerate'
...
export default function App() {
  ...
  const [mode, setMode] = useState(hasApiKey() ? 'api' : 'template')
  ...
  return (
    <div className="relative isolate min-h-screen grid-bg">
      ...
      <Header mode={mode} setMode={setMode} hasApiKey={hasApiKey()} />

      <main className="relative max-w-5xl mx-auto px-4 sm:px-6 pb-24">
        <InputForm
          input={input}
          setInput={setInput}
